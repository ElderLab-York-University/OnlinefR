function [associationSeg,vp_info,euler_angles,runTime]=manhattanFrameEstimationMethod6(lineSegments,fullLineIndex,pp, focal,test_inits,sampleFocal,gd,ublb,pdfdhtable,pdfdvtable)

fOps = 35;
% fmin_options = getOptionsValuesForOptimization('fminunc', fOps);
% load('vp_estimation/kernel_based_collected_results_newton.mat')
